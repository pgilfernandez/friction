...
public:
    ...
    static const QColor getThemeColorGray();
    static const QColor getThemeColorDarkGray();
    static const QColor getThemeColorBlack();
    static const QColor getThemeColorWhite();
