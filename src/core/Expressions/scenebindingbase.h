...
#ifndef SCENEBINDINGBASE_H
#define SCENEBINDINGBASE_H

#include <QObject>

// #include "framerange.h"
#include "Properties/property.h" // Is it needed?

#include <QJSValue>

class CORE_EXPORT SceneBindingBase : public QObject {
    Q_OBJECT
protected:
    SceneBindingBase(const Property* const context);
public:
    ...
    // virtual bool dependsOn(const Scene* const prop) {
    //     Q_UNUSED(prop)
    //     return false;
    // }
